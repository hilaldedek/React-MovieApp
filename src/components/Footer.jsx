...
const Footer = () => {
  ...
  return (
    <div>
         <footer className="bg-danger-100 text-center text-gray-700 fixed left-0 bottom-0 right-0">
        <div className="container px-6 pt-6 relative m-auto">
          <div className="mb-6 flex justify-center">
            ...
            <a href="#!" type="button" className="m-1 h-9 w-9 rounded-full border-2 border-gray-800 text-gray-800 uppercase leading-normal transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0" data-te-ripple-init data-te-ripple-color="light">
              <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto h-full w-4" fill="currentColor" viewBox="0 0 24 24">
